<?php
	class Model_rekening_jenis extends CI_Model
	{
		var $table					= 'ref_rekening_3';
		var $column_order		= array(null,'rekening_1','rekening_2','rekening_3','nama_rekening_3',null);
		var $column_search	= array('rekening_1','rekening_2','rekening_3','nama_rekening_3');
		var $order					= array('rekening_1'=>'asc','rekening_2'=>'asc','rekening_3'=>'asc');
		...
		{
			$this->db2->select('rekening_1,rekening_2,rekening_3,nama_rekening_3');
			$this->db2->from('ref_rekening_3');
			$this->db2->where(
				array(
		...
		function data_detail($rekening_1,$rekening_2,$rekening_3)
		{
			$this->db2->from($this->table);
			$this->db2->where(
				array(
		...
		function rek_jenis_check($rekening_1,$rekening_2,$rekening_3)
		{
			$this->db2->select('rekening_1,rekening_2,rekening_3');
			$this->db2->from('ref_rekening_3');
			$this->db2->where(
				array(
					'rekening_1' => $rekening_1,
		...
		function data_hapus($rekening_1,$rekening_2,$rekening_3)
		{
			$this->db2->where(
				array(
					'rekening_1' => $rekening_1,
		...
		function cetak_data()
		{
			return $query = $this->db2->query("CALL sp_rekening_3('".$this->uri->segment(5)."','".$this->uri->segment(6)."')")->result();
		}
	}
